...
export const meta: MetaFunction = () => {
  return [
    { title: 'Santri Online: Platform Edukasi Islam Modern' },
    {
      name: 'description',
      content:
        'Bergabunglah dengan Santri Online, platform edukasi Islam modern yang menyediakan berbagai kursus dan sumber daya untuk memperdalam pengetahuan agama Anda.',
    },
  ];
};
...
export default function Index() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Kelola hafalan, karya, dan sertifikat Anda dalam satu ekosistem digital.',
  ...
  const stats = [
    ...
    { icon: Heart, label: 'Program Aktif', value: '0', color: 'text-red-600' },
  ];
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20 relative z-10">
          <div className="text-center max-w-4xl mx-auto fade-in">
            ...
            <p className="mx-auto mt-4 sm:mt-6 max-w-xs sm:max-w-md lg:max-w-2xl text-sm sm:text-lg lg:text-xl text-muted-foreground leading-relaxed">
              Platform edukasi Islam terdepan yang menggabungkan teknologi modern dengan nilai-nilai
              islami. Tingkatkan hafalan, kelola karya, dan raih prestasi akademik Anda.
            </p>
            ...
            <div className="mt-6 sm:mt-8 lg:mt-10 flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center max-w-md sm:max-w-none mx-auto">
              <Button
                asChild
                size="lg"
                className="text-sm sm:text-base lg:text-lg px-6 sm:px-8 py-3 sm:py-4 h-auto w-full sm:w-auto"
              >
                <Link to="/daftar">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-r from-primary to-blue-600 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 text-center text-white fade-in">
            ...
            <p className="text-sm sm:text-lg lg:text-xl mb-6 sm:mb-8 opacity-90 max-w-xs sm:max-w-md lg:max-w-2xl mx-auto">
              Bergabunglah dengan ribuan santri lainnya dan rasakan pengalaman belajar yang tak
              terlupakan
            </p>
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center max-w-md sm:max-w-none mx-auto">
              <Button
                ...
                className="text-sm sm:text-base lg:text-lg px-6 sm:px-8 py-3 sm:py-4 h-auto w-full sm:w-auto"
              >
                <Link to="/daftar">Daftar Sekarang - Gratis!</Link>
              </Button>
              <Button
                asChild
                size="lg"
                variant="outline"
                className="text-sm sm:text-base lg:text-lg px-6 sm:px-8 py-3 sm:py-4 h-auto border-white/20 text-white hover:bg-white/10 w-full sm:w-auto"
              >
