...
export const meta: MetaFunction = () => {
  return [
    { title: 'Blog - Santri Online' },
    {
      name: 'description',
      content:
        'Baca artikel terbaru seputar edukasi Islam, teknologi, dan tips belajar di blog Santri Online.',
    },
  ];
};
...
export default function Blog() {
  const featuredArticle = {
    ...
    excerpt:
      'Bagaimana teknologi modern dapat memperkuat pembelajaran Islam tanpa menghilangkan nilai-nilai tradisional pesantren.',
  ...
  const articles = [
    {
      ...
      excerpt:
        'Manfaatkan aplikasi dan tools digital untuk mempercepat proses hafalan Al-Quran Anda.',
    ...
    {
      title: 'Strategi Mengelola Dompet Santri',
      excerpt: 'Panduan cerdas mengatur DinCoin dan DirCoin untuk kebutuhan belajar dan dakwah.',
      author: 'Tim Finansial Santri',
      date: '18 Juli 2025',
      readTime: '9 menit',
      category: 'Finansial',
      image: '/blog/dompet-santri.jpg',
    },
    {
      title: 'Teknologi AI dalam Pembelajaran Al-Quran',
      excerpt:
        'Bagaimana artificial intelligence dapat membantu santri dalam mempelajari Al-Quran.',
      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="mb-8">
          ...
          <div className="text-center">
            <h1 className="text-3xl md:text-4xl font-bold mb-4">Blog Santri Online</h1>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Temukan insight, tips, dan inspirasi seputar edukasi Islam modern, teknologi, dan
              pengembangan diri
            </p>
          </div>
        </div>
        ...
        <Card className="bg-gradient-to-r from-primary to-blue-600 text-white border-0">
          <CardContent className="p-8 text-center">
            ...
            <p className="mb-6 opacity-90 max-w-md mx-auto">
              Bergabunglah dengan ribuan santri lainnya untuk berbagi ilmu dan pengalaman
              pembelajaran Islam.
            </p>
